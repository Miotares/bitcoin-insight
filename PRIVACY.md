...
- **Supabase** (our cached statistics endpoint) — the Home/Lock-screen widgets
  read pre-aggregated global network statistics (price, fees, block height). No
  wallet data is sent here.
